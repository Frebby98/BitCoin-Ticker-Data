      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          //TODO 3: You'll need to use a Column Widget to contain the three CryptoCards.
           CryptoCard(coinVal: 'BTC', value: isWaiting ? '?' : coinValues['BTC'], selectedCurrency: selectedCurrency),
          CryptoCard(coinVal: 'ETH', value: isWaiting ? '?' : coinValues['ETH'], selectedCurrency: selectedCurrency),
          CryptoCard(coinVal: 'LTC', value: isWaiting ? '?' : coinValues['LTC'], selectedCurrency: selectedCurrency),
    ...
    return Padding(
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Text(
            '1 $coinVal = $value $selectedCurrency',
